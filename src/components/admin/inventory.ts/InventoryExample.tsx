  ...
  return (
    <div className={styles.wrapper}>
      <div className="!border-none !rounded-none">
        <div className='flex items-center justify-between px-4 py-2 dark:bg-gray-900 dark:text-gray-100 bg-gray-100 text-gray-900 rounded-none border-none'>
          <div className='flex rounded-lg gap-1 overflow-hidden p-1 border-[0.5px] border-[rgba(77,76,76,0.1)] dark:border-gray-400'>
            {Object.entries(statuses).map(([key, displayValue]) => (
              <button
                className={`inline-block px-4 py-2 text-sm font-medium whitespace-nowrap rounded-md border-none cursor-pointer transition duration-300 
                  ${activeTab === key ? 'bg-white text-black shadow-md' : ' hover:bg-gray-200/20 hover:text-gray-100'}`}
